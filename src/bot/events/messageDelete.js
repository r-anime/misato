...
export default new EventListener('messageDelete', async (message, {client}) => {
	setTimeout(async () => {
		// Ignore if the message was deleted by a bot
	let logs = await message.channel.guild.getAuditLogs(50, null, 72);
